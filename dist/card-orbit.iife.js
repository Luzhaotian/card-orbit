...
var CardOrbit = (() => {
  ...
  __export(src_exports, {
    CardOrbit: () => CardOrbit,
    CardOrbitMobile: () => CardOrbitMobile,
    DEFAULT_ACTIVE_WINDOW: () => DEFAULT_ACTIVE_WINDOW,
    DEFAULT_AUTO_SPEED: () => DEFAULT_AUTO_SPEED,
    DEFAULT_DRAG_SENSITIVITY: () => DEFAULT_DRAG_SENSITIVITY,
  ...
  var globalReact = globalThis.React;
  if (!globalReact) {
    throw new Error(
      '[card-orbit] browser build: global "React" not found. Load a UMD build of React (react@18.3.x) before card-orbit.'
    );
  }
  var Fragment = globalReact.Fragment;
  var createElement = globalReact.createElement;
  var useEffect = globalReact.useEffect;
  var useRef = globalReact.useRef;
  var useState = globalReact.useState;
  ...
  // src/browser/jsx-runtime.ts
  function jsx(type, props, key) {
    const create = createElement;
    return key === void 0 ? create(type, props) : create(type, { ...props, key });
  }
  ...
  function CardOrbitMobile({
    ...
    return /* @__PURE__ */ jsx("div", { className: rootClass, style, children: /* @__PURE__ */ jsx(
      "div",
      {
        className: ["card-orbit-mobile__track", trackClassName].filter(Boolean).join(" "),
        style: { animationDuration: `${durationSec}s` },
        children: loop.map((src, i) => /* @__PURE__ */ jsx(
          "figure",
          {
...
//# sourceMappingURL=card-orbit.iife.js.map